...
def save_to_elasticsearch(**context):
    ...
    for price_info in gas_prices:
        ...
        es.index(index="gas_prices", body=doc)
...
dag = DAG(
    ...
    description='DAG to scrape gas prices and save to Elasticsearch',
...
save_to_elasticsearch_task = PythonOperator(
    task_id='save_to_elasticsearch_task',
    python_callable=save_to_elasticsearch,
    provide_context=True,
    dag=dag,
)

scrape_gas_prices_task >> save_to_elasticsearch_task
